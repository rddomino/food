window.addEventListener('DOMContentLoaded', () => {
    ...
    // скрываю все табы, скрываю класс активности у меню
    ...
    // Появление модального окна по времени и в конце страницы
    ...
    function initTotalSettings(selector, activeClass) {
    ...
    initTotalSettings('#gender div', 'calculating__choose-item_active');
    initTotalSettings('.calculating__choose_big div', 'calculating__choose-item_active');
